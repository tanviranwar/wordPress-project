...
<div class="blog-wrap">
	...
	<div class="blog-grid">
		...
		<div class="post format-image box"> 
			<div class="frame">
				<a href="post.php">
					<img src="<?php echo get_template_directory_uri();?>/images/art/post1.jpg" alt="" />
				</a>
			</div>
		...
		<div class="post format-video box"> 
			...
			<h2 class="title"><a href="post.php">Fragments of Iceland</a></h2>
		...
		<div class="post format-audio box"> 
			<div class="video frame"><iframe width="100%" height="300" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/29449040&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe></div>
			<p><b>Icona Pop</b> (English <a href="http://en.wikipedia.org/wiki/Help:IPA_for_English">/</a><a href="http://en.wikipedia.org/wiki/Help:IPA_for_English#Key">aɪˈkɒnə</a> <a href="http://en.wikipedia.org/wiki/Help:IPA_for_English#Key">pɒp</a><a href="http://en.wikipedia.org/wiki/Help:IPA_for_English">/</a>) is a Swedish <a href="http://en.wikipedia.org/wiki/DJ">DJ</a> duo that formed in 2009, with <a href="http://en.wikipedia.org/wiki/Electro_house">electro house</a>, <a href="http://en.wikipedia.org/wiki/Punk_rock">punk</a> and <a href="http://en.wikipedia.org/wiki/Indie_pop">indie pop</a> music influences. The two members <b>Caroline Hjelt</b> and <b>Aino Jawo</b>, who grew up in <a href="http://en.wikipedia.org/wiki/Stockholm">Stockholm</a>, create music "which you can both laugh and cry to at the same time". They signed to <a href="http://en.wikipedia.org/wiki/TEN_Music_Group">TEN Music Group</a> in 2009. Their biggest hit to date has been "<a href="http://en.wikipedia.org/wiki/I_Love_It_(Icona_Pop_song)">I Love It</a>".</p>
		...
		<!-- End Audio Format -->  					
 		...
 		<div class="post format-standard box"> 
			...
			<h2 class="title"><a href="post.php">The Meridian Sun</a></h2>
	...
	<p>Then I feel the presence of the Almighty, who formed us in his own image, and the breath of that universal love which bears and sustains us, as it floats around us in an eternity of bliss; and then, my friend, when darkness overspreads my eyes, and heaven and earth seem to dwell in my soul and absorb its power, like the form of a beloved mistress, then I often think with longing, Oh, would I could describe these conceptions, could impress upon paper all that is living so full and warm within me, that it might be the mirror of my soul, as my soul is the mirror of the infinite God!</p>
		...
		<div class="post format-chat box"> 
			<h2 class="title"><a href="post.php">Two Best Friends</a></h2>
			<ul>
