...
add_filter( 'loop_shop_columns', 'cg_loop_columns' );

if ( ! function_exists( 'cg_loop_columns' ) ) {
	function cg_loop_columns() {
		global $cg_options;
		$woo_product_grid_count = $cg_options['product_grid_count'];
		if ( $woo_product_grid_count ) {
			return $woo_product_grid_count;
		} else {
			return 4;
		}
	}
...
if ( ! function_exists( 'cg_woocommerce_cart_dropdown' ) ) {
	...
	function cg_woocommerce_cart_dropdown() {
		...
		<?php } else { ?> 
			...
			if ( sizeof( $woocommerce->cart->cart_contents ) > 0 ) :
				...
				echo '<li class="buttons"><a href="' . esc_url( WC()->cart->get_cart_url() ) . '" class="button">' . __( 'View Cart', 'commercegurus' ) . '</a> <a href="' . $woocommerce->cart->get_checkout_url() . '" class="button checkout">' . __( 'Checkout', 'commercegurus' ) . '</a></li>';
			endif;
