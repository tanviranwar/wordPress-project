...
function cg_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source' => 'http://files.commercegurus.com/commercegurus-toolkit-1.6.2.zip', // The plugin source
			'required' => true, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'             => 'http://files.commercegurus.com/layersliderwp-6.5.5.installable.zip', // The plugin source
			'required'           => false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'             => 'http://files.commercegurus.com/js_composer_5.2/js_composer.zip', // The plugin source
			'required'           => false, // If false, the plugin is only 'recommended' instead of required
...
if ( ! function_exists( 'cg_setup' ) ) :
	...
	function cg_setup() {
		...
		if ( function_exists( 'add_theme_support' ) ) {
			...
			add_image_size( 'showcase-4col', 300, 190, true ); // Showcase 4Col thumbnail
			add_image_size( 'showcase-3col', 380, 260, true ); // Showcase 3Col thumbnail
			add_image_size( 'showcase-2col', 600, 450, true ); // Showcase 2Col thumbnail
