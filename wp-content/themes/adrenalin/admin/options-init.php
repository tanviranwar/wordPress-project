		...
		public function setSections() {
			...
			'button',
				...
				'.wpcf7 input.wpcf7-submit',
							'ul.navbar-nav li .nav-dropdown > ul > li.menu-parent-item > a',
				...
				'.cg-quickview-product-pop .product_title',
				'.cg-strip-wrap h1',
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'title' => __( 'Enable custom lightbox. NOTE: This feature is deprecated in WooCommerce 3.0+ If you are experiencing issues with variation images please disable the custom lightbox by setting this to No', 'commercegurus' ),
						'default' => 'no',
					),
					array(
